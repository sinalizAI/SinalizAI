...
from controllers.verify_token_controller import VerifyTokenScreen
...
Builder.load_file("views/verify_token_page/verify_token.kv")
...
class ScreenManagement(MDScreenManager):
    def __init__(self, **kwargs):
        ...
        self.add_widget(VerifyTokenScreen(name="verify_token"))
